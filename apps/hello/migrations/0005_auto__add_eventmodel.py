...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EventModel'
        db.create_table(u'hello_eventmodel', (
        ...
        db.send_create_signal(u'hello', ['EventModel'])


    def backwards(self, orm):
        # Deleting model 'EventModel'
        db.delete_table(u'hello_eventmodel')
