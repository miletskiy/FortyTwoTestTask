...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DatabaseRequest.priority'
        db.add_column(u'hello_databaserequest', 'priority',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DatabaseRequest.priority'
        db.delete_column(u'hello_databaserequest', 'priority')
