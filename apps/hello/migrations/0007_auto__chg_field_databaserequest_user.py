...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'hello_databaserequest', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], to_field='username', null=True))
    ...
    models = {
        ...
        u'hello.databaserequest': {
            ...
            'priority': ('django.db.models.fields.IntegerField', [], {'default': '0', 'max_length': '10'}),
            'title': ('django.db.models.fields.CharField', [], {'default': "'Request in database'", 'max_length': '30'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'to_field': "'username'", 'null': 'True', 'blank': 'True'})
        },
        u'hello.eventmodel': {
            'Meta': {'object_name': 'EventModel'},
            'emergence': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
